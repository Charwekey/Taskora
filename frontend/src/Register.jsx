    ...
    return (
        <div className="min-h-screen bg-[#7FA5A4] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 left-20 w-96 h-96 bg-[#C9A068]/10 rounded-full blur-3xl"></div>
                <div className="absolute bottom-20 right-20 w-80 h-80 bg-white/20 rounded-full blur-3xl"></div>
            </div>
                    ...
                    <div className="space-y-6">
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-[#4A6565]">
                                Create an account and get organized today
                            </p>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="block w-full px-4 py-3 rounded-xl bg-white/60 backdrop-blur-sm border border-white/40 focus:border-[#C9A068] focus:bg-white/80 focus:ring-2 focus:ring-[#C9A068]/20 text-[#2B3D3E] placeholder-[#4A6565]/50 transition-all duration-200 outline-none pr-10"
                                            placeholder="Create a password"
                                        />
                                        <button
                                            type="button"
                                            onClick={() => setShowPassword(!showPassword)}
                                            className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#4A6565] hover:text-[#2B3D3E] cursor-pointer focus:outline-none"
                                        >
                                            {showPassword ? (
                                ...
                                <div>
                                    <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#2B3D3E] mb-2">
                                        Confirm password
                                    </label>
                                    <input
                                        id="confirmPassword"
                        ...
                        <div className="pt-6 border-t border-white/20">
                            <p className="text-center text-[#4A6565]">
                                ...
                                <Link to="/login" className="font-semibold text-[#C9A068] hover:text-[#B8905A] transition-colors">
                                    Sign in
                                </Link>
                            </p>
                        </div>
